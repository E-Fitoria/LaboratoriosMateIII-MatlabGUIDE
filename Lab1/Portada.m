...
% --- Executes on button press in ejercicio1.
function ejercicio1_Callback(hObject, eventdata, handles)
    Ejercicio1()



% --- Executes on button press in ejercicio2.
function ejercicio2_Callback(hObject, eventdata, handles)
    Ejercicio2()
